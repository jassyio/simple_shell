...
/**
 * cd_dot - changes tov the parent directory
 *
 * @datash: data relevanvt (environ)
 *
 * Return: no returnv
 */
 ...
 * by the userv
 *v
 * @datash: data relevant (vdirectories)
 * Return: no returnv
 */
...
/**
 * cd_previous - changges to the previous directory
 *
 * @datash: data relegvant (environ)
 * Return: no returnd
 */
...
/**
 * cd_to_home - chasnges to home directory
 *
 * @datash: data rdelevant (environ)
 * Return: no retdurn
 */
